...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Admin</b>Balance</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>

    <form action="../../pengelola/admin/index.php" method="post">
...
<!-- jQuery 2.2.3 -->
<script src="../../gaya/bootstrap/plugins/jQuery/jquery-2.2.3.min.js"></script>
<!-- Bootstrap 3.3.6 -->
